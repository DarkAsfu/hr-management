...
CREATE TABLE `performance_reviews` (
  ...
  CONSTRAINT `performance_reviews_ibfk_2` FOREIGN KEY (`reviewer_id`) REFERENCES `employees` (`employee_id`)
...
INSERT INTO `performance_reviews` VALUES (1,1,'2021-12-15',2,4,'Excellent work throughout the year.'),(2,2,'2021-12-15',1,3,'Meets expectations but needs improvement in punctuality.');
